...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Thanh Hương-Trường TH Liên Hiệp - ĐT: 0984721941=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Thanh Hương - Trường Tiểu học Liên Hiệp - ĐT: 0984721941</div>", unsafe_allow_html=True)
